...
bool Resource::partialMemCopyTo(VirtualGPU& gpu, const amd::Coord3D& srcOrigin,
  ...
  if (desc().buffer_ && !dstResource.desc().buffer_) {
    ...
    Pal::SubresId ImgSubresId = {Util::uint8(0), static_cast<Util::uint8>(dstResource.desc().baseLevel_), static_cast<Util::uint16>(arraySliceIdx)};
    ...
    Pal::SubresId ImgSubresId = {Util::uint8(0), static_cast<Util::uint8>(desc().baseLevel_), static_cast<Util::uint16>(arraySliceIdx)};
    copyRegion.imageSubres = ImgSubresId;
